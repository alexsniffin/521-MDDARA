...
CREATE TABLE HCProf (
	...
	Password CHAR(32),
	Username CHAR(32),
	Title CHAR(8) CHECK(Title=”Dr.” OR Title=“Nurse”) , -- Should be a fixed set of titles, e.g. Dr., etc
...
CREATE TABLE Documents (
	Document_ID PRIMARY KEY AUTO_INCREMENT,
	Type VARCHAR(4),
Doctor_ID INT REFERENCES Users(User_ID),
	Patient_ID INT REFERENCES Users(User_ID),
...
CREATE TABLE Results (
	...
	Patient_ID INT REFERENCES Users(User_ID),
	Com_ID INT REFERENCES Compound(Com_ID),
	Result REAL CHECK(Result>0), -- Should not be negative (Not sure if we even need this field because we hold values in the docs) 
);
